...
public class UITestNotLoggedIn {
    ...
    public void uiTest() {
        ...
        ViewInteraction appCompatEditText = onView(
                allOf(withId(R.id.country),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        appCompatEditText.perform(replaceText("poland"), closeSoftKeyboard());
        ...
        ViewInteraction tabView = onView(
                allOf(withContentDescription("Your Countries"),
                        childAtPosition(
                                childAtPosition(
        ...
        ViewInteraction textView = onView(
                allOf(withText("Please give 12"),
                        childAtPosition(
                                ...
                                0),
                        isDisplayed()));
        textView.check(matches(withText("Please give 12")));
    }
